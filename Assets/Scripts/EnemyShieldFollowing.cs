...
public class EnemyShieldFollowing : MonoBehaviour {
    ...
    private float control_K = 50.0f;
    private float control_C = 7.0f;
    private float controlRotation_K = 10.0f;
    private float controlRotation_C = 2f;
    private float HandExhaustValue;
    private float HandEnergyValue;
    private float HandAngularExhaustValue;

    private float RegenarationSpeed = 25f;
